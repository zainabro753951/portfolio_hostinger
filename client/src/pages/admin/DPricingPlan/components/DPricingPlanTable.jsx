  ...
  return (
    <motion.div variants={containerVariants} initial="hidden" animate="show" className="w-full">
      ...
      >
        ...
        >
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            >
              ...
              <span className="text-xs text-cyan-300 font-medium">Active Plans</span>
              ...
              <thead>
                <tr style={{ borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
                  {headers.map((head) => (
                    ...
                    >
                      <div className="flex items-center gap-2">
                        {head.icon && <head.icon size={14} color="#22d3ee" strokeWidth={2} />}
                        {head.label}
                      </div>
                    </th>
                  ))}
                  ...
                  <tr>
                    <td colSpan={8} className="py-16 text-center">
                      ...
                      >
                        ...
                        >
                          <CreditCard size={32} color="#22d3ee" strokeWidth={1.5} />
                        </div>
                        <div className="flex flex-col gap-2">
                          ...
                          <p className="text-slate-500 text-sm max-w-[280px]">
                            Create your first pricing plan to start managing your subscription tiers
                          </p>
                        </div>
                        <Link
        ...
        {/* ── Footer ────────────────────────────────────────────── */}
        {planCount > 0 && (
          <div className="mt-5 flex items-center justify-between px-2" style={{ color: '#64748b' }}>
            <span className="text-xs">
              Showing <span className="text-slate-300 font-semibold">{planCount}</span> plans
            </span>
            <span className="text-xs">
              Last updated:{' '}
